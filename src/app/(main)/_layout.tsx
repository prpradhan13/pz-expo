...
export const Layout = () => {
  ...
  const userNameInitials = useMemo(() => getInitialLetter(user?.fullName), [user?.fullName]);
  ...
  return (
    <>
      <Stack screenOptions={{ headerShadowVisible: false, headerTitleAlign: 'center', headerStyle: {backgroundColor: "#242424"} }}>
        <Stack.Screen 
          name="(tabs)" 
          options={{
            headerLeft: () => (
              <View className='w-[40px] h-[40px] bg-mainBgColor rounded-full flex justify-center items-center'>
                ...
                >
                  <Text className='text-primaryTextColor font-bold'>{userNameInitials}</Text>
                </TouchableOpacity>
              </View>
            ),
            headerRight: () => (
            ...
            headerTitle: () => (
              <Text style={{ fontFamily: 'Pacifico_400Regular' }} className='text-borderColor text-2xl'>PZ</Text>
            ),
